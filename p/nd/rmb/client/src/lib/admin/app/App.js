...
import '../lib/infra/layout/layout.css';
import './App.css';
...
class App extends Component {
  constructor() {
    ...
    this.createMenu();
    let i = _csm('admin').core()
    let j = i.default.core;
    j.consoleHello()
    console.log(cmsDistributionMode)
  }
  ...
  createMenu() {
    this.menu = [
      { label: 'Org Tree', icon: 'pi pi-fw pi-home', command: () => { window.location = '#/org-tree' } },
      ...
      {
        label: 'Prac Pages', icon: 'pi pi-fw pi-search',
        items: [
          {
            label: 'Org Chart', icon: 'pi pi-fw pi-bookmark',
            items: [
              {
                label: 'Submenu 2.1', icon: 'pi pi-fw pi-bookmark',
                items: [
                  { label: 'Org Chart', icon: 'pi pi-fw pi-bookmark', to: '/org-chart' },
